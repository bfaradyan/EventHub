...
<head>
    ...
    <title>Create Event - Event Hub</title>
    ...
    <div class="bg-white rounded-lg shadow p-8">
        ...
        <form action="{{ route('events.store') }}" method="POST">
            ...
            <div class="flex flex-col md:flex-row gap-3 md:gap-4">
                <button
                    type="submit"
                    class="bg-blue-600 text-white px-6 py-2 rounded-lg transition duration-400 hover:bg-blue-700 font-medium w-full md:w-auto text-center"
                >
                    Create Event
                </button>
                <a
